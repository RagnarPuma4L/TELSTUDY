...
def main(page: ft.Page):
    ...
    def change_study(e):
        page.clean()
        modo = ft.Text("Elige la modalidad pomodoro", size=60, color="#3B5BDB", weight=ft.FontWeight.BOLD)

        simple = ft.ElevatedButton(
            content=ft.Column([
                ft.Image(src="pomsim.png", width=300, height=300),
                ft.Text("Pomodoro + Lista de Tareas", color="#FFFFFF", text_align="center")
            ],
        ...
        adv = ft.ElevatedButton(
            content=ft.Column([
                ft.Image(src="pomsim.png", width=300, height=300),
                ft.Text("Pomodoro + Lista de Tareas + Planificación", color="#FFFFFF", text_align="center")
            ],
            alignment=ft.MainAxisAlignment.CENTER,
            horizontal_alignment=ft.CrossAxisAlignment.CENTER),
